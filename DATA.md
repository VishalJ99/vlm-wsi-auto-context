...
- `/data2/vj724/vlm-wsi-auto-context/runs/stage1_detector_pilot_v1/`: ignored local output root for the PER-188 Stage 1 detector pilot control plane; contains the balanced 100-WSI worklist, the 20-WSI manual review gate, generated Stage 1 and guard command files, the Stage 1 detection-reviewer smoke test under `stage1_detection_review_v1/`, and `reproduction.txt`.
